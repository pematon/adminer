	...
	foreach ($fields as $i => $field) {
		...
		if (support("move_col")) {
			echo "<button name='add[$i]' value='1' title='" . h(lang('Add next')) . "' class='light'><svg class='icon'><use href='static/icons.svg#add'/></svg></button>",
				"<button name='up[$i]' value='1' title='" . h(lang('Move up')) . "' class='jsonly light'><svg class='icon'><use href='static/icons.svg#arrow-up'/></svg></button>",
				"<button name='down[$i]' value='1' title='" . h(lang('Move down')) . "' class='jsonly light'><svg class='icon'><use href='static/icons.svg#arrow-down'/></svg></button>";
		}
