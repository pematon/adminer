...
class AdminerDesigns {
	...
	/**
	 * @param array URL in key, name in value. If not provided, designs will be auto-discovered.
	 */
	...
	function css() {
		if(empty($this->designs)) {
			echo "<br> No designs available !! Please copy designs from source code in 'designs' directory (for example designs/ng9/adminer.css) or desactivate 'designs' plugin";
			exit;
		}
